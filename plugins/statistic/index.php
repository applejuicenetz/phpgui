...
echo'<div class="card mb-4">
		<div class="card-body">
			<ul class="nav">
				<li class="nav-item">
    				<a class="nav-link active" aria-current="page" href="?site=Extras&plugin=statistic&stats=-last">
				...
				<li class="nav-item">
    				<a class="nav-link active" aria-current="page" href="?site=Extras&plugin=statistic&amp;stats=-most">
				...
				<li class="nav-item">
    				<a class="nav-link active" aria-current="page" href="?site=Extras&plugin=statistic&amp;stats=-search">
    					h&auml;ufig gesucht
    				</a>
				</li>
				<li class="nav-item">
...
if(!empty($Sharelist->cache['SHARES']['VALUES']['SHARE'])){
    ...
    date("j.n.y - H:i:s", (int)($wert / 1000)) : $wert;
			echo "</td><td>";
