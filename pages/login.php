    ...
    <div class="container">
        <div class="row justify-content-center">
                ...
                <div class="card-group d-block d-md-flex row">
                    <div class="card col-md-7 p-4 mb-0">
                        <div class="card-body">
                            ...
                            ?>
                            <form name="core" action="index.php?login=1" method="post" id="login_form">
                                <input type="hidden" name="ajfsp_link" value="" id="ajfsp_link"/>
                                <div class="form-floating mb-3">
                                    <input type="url" class="form-control" placeholder="Core-URL" name="host" id="chost"
                                           value="<?php echo ($_ENV['CORE_HOST'] ?: $_ENV['REAL_IP']) . ':' . $_ENV["CORE_PORT"]; ?>"
                                           required/>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="password" class="form-control" name="cpass" id="cpass"
                                           required/>
                                    <label for="cpass"><?php echo $lang->Login->password; ?></label>
                                </div>
                                <div class="row">
                                    <div class="col-">
                                        <div class="checkbox icheck m-l--20">
                                            <label><input type="checkbox"> <?php echo $lang->Login->remember; ?></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <button class="btn btn-primary px-4"
                                                    type="submit"><?php echo $lang->Login->login; ?></button>
                                        </div>
            ...
            <div class="card col-md-5 text-white bg-danger py-5"
                 style="background-image: url(themes/CoreUI/assets/img/signin-bg.jpeg); backgound-position: center;">
