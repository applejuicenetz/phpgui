...
class Icons{
	...
	function __construct(){
		...
		$this->directstate = array(
			"0" => "<img src='themen/icons/unknow.png' alt='?' />",
			"1" => "<img src='themen/icons/direct.png' alt='direct' />",
			"2" => "<img src='themen/icons/indirect.png' alt='indirect' />",
			"3" => "<img src='themen/icons/indirect.png' alt='indirect' />");
	}
}