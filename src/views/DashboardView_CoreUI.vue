...
const userStats = [
  { title: 'Aktive Benutzer', icon: cilUser, value: 78 },
  { title: 'Neue Benutzer', icon: cilUserFemale, value: 22 },
]
      ...
      <CCol :sm="6" :lg="3">
        <CCard class="mb-4 text-white bg-primary">
          <CCardBody class="pb-0 d-flex justify-content-between align-items-start">
            ...
            <CIcon :icon="cilPeople" height="52" class="text-white-50" />
          </CCardBody>
          <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
            <!-- Hier könnte ein kleines Chart hin -->
          </div>
        </CCard>
      </CCol>
      ...
      <CCol :sm="6" :lg="3">
        <CCard class="mb-4 text-white bg-success">
          <CCardBody class="pb-0 d-flex justify-content-between align-items-start">
            ...
            <CIcon :icon="cilDataTransferDown" height="52" class="text-white-50" />
          </CCardBody>
          <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
            <!-- Hier könnte ein kleines Chart hin -->
          </div>
      ...
      <CCol :sm="6" :lg="3">
        <CCard class="mb-4 text-white bg-warning">
          <CCardBody class="pb-0 d-flex justify-content-between align-items-start">
            ...
            <CIcon :icon="cilDataTransferUp" height="52" class="text-white-50" />
          </CCardBody>
          <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
            <!-- Hier könnte ein kleines Chart hin -->
          </div>
      ...
      <CCol :sm="6" :lg="3">
        <CCard class="mb-4 text-white bg-info">
          <CCardBody class="pb-0 d-flex justify-content-between align-items-start">
            ...
            <CIcon :icon="cilSpeedometer" height="52" class="text-white-50" />
          </CCardBody>
          <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
            <!-- Hier könnte ein kleines Chart hin -->
          </div>
      ...
      <CCol :md="12">
        <CCard class="mb-4">
          <CCardBody>
            ...
            <CRow>
              <!-- Hier würde normalerweise das MainChart Component hin -->
              <div class="mt-4 p-4 bg-light rounded text-center">
                <CIcon :icon="cilGraph" height="100" class="text-muted mb-3" />
          ...
          <CCardBody>
            <CTable align="middle" class="mb-0 border" hover responsive>
              <CTableHead class="text-nowrap">
                <CTableRow>
                  <CTableHeaderCell class="bg-body-tertiary">
