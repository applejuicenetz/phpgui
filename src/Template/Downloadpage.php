...
class Downloadpage
{
    static function list_once($status, $title, $balken, $sources, $size, $parts, $rest, $speed, $time, $restzeit, $a)
    {
        if($balken != "100")
        {
            $balken_color = "info";
        ...
        echo'    <div class="col-12 col-lg-12 col-xl-12 col-xxl-12 mb-1" id="zeile_' . $a . '">
                        <div class="card">
                          <div class="card-body">
                            <div class="row">
                            <div class=" col-6">
                            ...
                            <div class="small text-body-secondary text-uppercase fw-semibold text-truncate">' . $sources . ' | ' . $size . ' | ' . $parts . '</div>
