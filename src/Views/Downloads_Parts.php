...
echo "<td width=\"20\" style=\"background:#0000FF;\">&nbsp;</td><td>"
	.$language->translate('Downloads.parts.available')."</td>";
echo "<td width=\"20\" style=\"background:#FF0000;\">&nbsp;</td><td>"
	.$language->translate('Downloads.parts.NA')."</td>\n";
echo "</tr>\n";
echo "<tr>";
echo "<td width=\"20\" style=\"background:#000000;\">&nbsp;</td><td>"
	.$language->translate('Downloads.parts.received')."</td>";
echo "<td width=\"20\" style=\"background:#00FF00;\">&nbsp;</td><td>"
	.$language->translate('Downloads.parts.checked')."</td>";
echo "</tr>\n";
echo "<tr>";
echo "<td width=\"20\" style=\"background:#FFFF00;\">&nbsp;</td>"
	."<td colspan=\"3\">h"
	.$language->translate('Downloads.parts.active_transfer')."</td>\n";
echo "</tr>\n";
echo "</table><br />\n";

//user oder downloadbild
if(!empty($_GET['dl_id'])){
	echo "<img src=\"src/Views/showparts.php?dl_id=".$_GET['dl_id']."&amp;"
		.SID."\" alt='download partlist' />\n";
}elseif(!empty($_GET['usr_id'])){
	echo "<img src=\"src/Views/showparts.php?usr_id=".$_GET['usr_id']."&amp;"
