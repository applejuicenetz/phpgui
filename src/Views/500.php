...
<head>
    ...
    <title>500 | appleJuice phpGUI</title>
    <!-- Favicon -->
        ...
        <div class="row clearfix">
            ...
            <div class="col-sm-4">
                <div class="error-box">
                    ...
                    <div class="info">
                        The server encountered an internal error and was unable to complete your request, <a href="javascript:void(0);">Report this</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-4"></div>
